...
enum JBSport { running, gym, cycling, cricket, football, yoga, hiit }
...
extension JBSportLabel on JBSport {
  ...
  EqPreset get eqPreset => switch (this) {
        ...
        JBSport.football => EqPreset.hipHop,
        JBSport.yoga     => EqPreset.classical,
        JBSport.hiit     => EqPreset.rock,
      };
}

enum HRZone { recovery, aerobic, tempo, threshold, anaerobic }
...
extension HRZoneLabel on HRZone {
  ...
  (int, int) get musicBpmRange => switch (this) {
  ...
  EqPreset get eqPreset => switch (this) {
        ...
        HRZone.anaerobic => EqPreset.hipHop,
      };
}
...
class TrainingSession {
  ...
  String get phaseLabel {
    ...
    if (sport == JBSport.hiit || sport == JBSport.gym) {
      return mins < 30 ? 'Training' : 'Cooldown';
    }
